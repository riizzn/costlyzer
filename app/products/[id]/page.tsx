  ...
  return (
    <div className="product-container">
        ...
        <div className="flex-1 flex flex-col">
          <div className="flex justify-between items-start gap-5 flex-wrap pb-6">
            <div className="flex flex-col gap-3">
              <p className=" leading-[40px] tracking-tight text-black text-[28px] font-semibold">
                {product.title}
              </p>
              <Link
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="bg-lilac p-2 rounded-10">
                <Image
          ...
          <div className="product-info">
            ...
            <div className="flex   flex-col gap-4">
              ...
              <p className="mt-2text-sm text-black/50">
      ...
      <div className="flex flex-col gap-16 ">
        ...
        <button className="bg-black p-5 rounded-2xl w-fit mx-auto flex items-center justify-center gap-1 min-w-[200px]">
